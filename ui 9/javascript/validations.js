...
//alert("check");	
	...
	{
		alert("please enter password and should be end with $ or @");
		document.getElementById("pwd").focus();
		return false;
	...
	else if(!mobile1.match(mobilePattern))
	{
		alert("please enter mobile and should be numeric numbers");
		document.getElementById("mobile").focus();
		return false;
